...
class LightThemeColors
{
  ...
  static const Color primaryColorLight = Color(0xff181818);
  ...
  //ICONS
  static const Color appBarIconsColor = Color(0xFFDBDBDB);
  static const Color iconColor = Color(0xff181818);
  static const Color selectedIconColor = Color(0xFFEA3434);
